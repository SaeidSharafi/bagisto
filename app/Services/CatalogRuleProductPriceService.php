...
use App\Repositories\JeduCatalogRuleProductPriceRepository;
use Carbon\Carbon;
use Webkul\CatalogRule\Helpers\CatalogRuleProduct;
use Webkul\Customer\Repositories\CustomerGroupRepository;

class CatalogRuleProductPriceService

{
    ...
    public function __construct(
        JeduCatalogRuleProductPriceRepository $catalogRuleProductPriceRepository,
