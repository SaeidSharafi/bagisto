...
class DatabaseTokenRepository implements \Illuminate\Auth\Passwords\TokenRepositoryInterface
{
    ...
    public function create(CanResetPasswordContract $user)
    {
        ...
        if ($user instanceof JeduCustomer) {
    ...
    protected function deleteExisting(CanResetPasswordContract $user)
    {
        return $this->getTable()
            ...
            ->when($user instanceof JeduCustomer, function($query) use ($user){
                $query->orWhere('phone', $user->getPhoneForPasswordReset());
            })
            ->delete();
    }
