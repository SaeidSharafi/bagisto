...
return [
    ...
    'customer' => [
        ...
        'signup-form' => [
            ...
            'success-verify-email-unsent' => 'حساب با موفقیت ایجاد شد ، اما نامه الکترونیکی ارسال نشده است',
        ...
        'login-form' => [
            ...
            'email'               => 'پست الکترونیک',
            'password'            => 'کلمه عبور',
            'form-otp-text'       => 'ورود با رمز یکبار مصرف',
            'otp'                 => 'کد تایید برای شماره :phone پیامک شد',
            'otp_field'           => 'کد تایید',
            'otp-link'            => 'ورود با رمز یکبارمصرف',
            'forgot_pass'         => 'رمز عبور را فراموش کرده اید؟',
            'button_title'        => 'ورود',
            'remember'            => 'مرا به خاطر بسپار',
            'footer'              => '© حقوق النشر :year Webkul Software ، جميع الحقوق محفوظة',
            'invalid-creds'       => 'اطلاعات وارد شده نادرست است',
        ...
        'reset-password' => [
            ...
            'submit-btn-title' => 'تغییر رمز عبور'
        ],
        ...
        'account' => [
            ...
            'order' => [
                'index' => [
                    ...
                    'completed'        => 'تکمیل شد',
                    'canceled'         => 'لغو شد',
                    'paymeny_canceled' => 'خطا در پرداخت',
                    'closed'           => 'بسته شد',
                    'pending'          => 'در انتظار',
                ...
                'view' => [
                    ...
                    'item-ordered'        => 'ثبت شده',
                    'item-invoice'        => ' صورتحساب',
                    'item-shipped'        => 'تکمیل شده',
                    'item-canceled'       => 'لغو شد',
                    'item-refunded'       => 'بازپرداخت',
                    'price'               => 'قیمت',
                    'total'               => 'جمع',
                    'subtotal'            => 'قیمت',
    ...
    'products' => [
        ...
        'sale'                     => 'فروش',
        'new'                      => 'جدید',
        'empty'                    => 'هیچ دوره ای در این گروه موجود نیست',
    ...
    'checkout' => [
        ...
        'success' => [
            ...
            'thanks'        => 'ثبت نام با موفقیت انجام شد',
            'order-id-info' => 'شماره پیگیری: :order_id',
            'info'          => 'اطلاعات ثبت نام به صورت پیامک برای شما ارسال خواهد شد.'
        ]
    ],
    ...
    'mail' => [
        ...
        'forget-password' => [
            ...
            'final-summary'  => 'اگر درخواست تغییر رمز عبور را نکردید ، دیگر نیازی به اقدامات لازم نیست',
            'thanks'         => 'با تشکر'
        ],
