...
return [
    'admin' => [
        ...
        'contents' => [
            ...
            'content' => [
                ...
                'custom-product' => 'دوره‌ها فروشگاهی',
        ...
        'meta-data' => [
            ...
            'activate-slider' => 'نمایش اسلایدر صفحه اول',
            'home-page-content' => 'محتوای صفحه اصلی',
            'footer-left-content' => 'ستون دوم',
            'subscription-content' => 'ستون اول',
            'sidebar-categories' => 'تعداد دسته‌بندی های منو',
            ...
            'button' => 'متن دکمه',
            'show_content' => 'نمایش محتوای متنی',
            ...
            'footer-middle-content' => 'ستون سوم',
    ...
    'checkout' => [
        ...
        'items' => 'موارد',
        'subtotal' => 'قیمت',
        'sub-total' => 'مجموع دوره ها',
        'proceed' => 'ادامه پرداخت',
    ],
    ...
    'customer' => [
        ...
        'login-form' => [
            'sign-up' => 'ثبت نام',
            'new-customer' => 'فراگیر جدید',
            'customer-login' => 'ورود فراگیر',
            'registered-user' => 'کاربر ثبت نام شده',
            'your-email-address' => 'آدرس ایمیل شما',
            'form-login-text' => 'رمز عبور را وارد کنید',
        ],
        'signup-form' => [
            'login' => 'وارد شدن',
            'become-user' => 'ورود / ثبت‌نام',
            'user-registration' => 'ثبت نام کاربر',
            'form-sginup-text' => 'شماره موبایل خود را وارد کنید',
        ],
        'verify-form' => [
        ...
        'forget-password' => [
            ...
            'recover-password-text' => 'برای تغییر رمز عبور، شماره موبایل خود را وارد کنید.',
        ],
        'wishlist' => [
    ...
    'error' => [
        'go-to-home'    => 'بازگشت به صفحه اصلی',
        'page-lost-short' => 'خطای 404',
        'something_went_wrong' => 'چیزی پیش آمد',
        'page-lost-description' => "صفحه مورد نظر در دسترس نیست. سعی کنید دوباره جستجو کنید یا از دکمه بازگشت به صفحه اصلی استفاده کنید.",
    ],
    ...
    'products' => [
        ...
        'recently-viewed' => 'دوره‌های اخیرا مشاهده شده',
    ...
    'shop' => [
        ...
        'general' => [
            ...
            'downloadables' => 'دوره‌های دانلودی',
