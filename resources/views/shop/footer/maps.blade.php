        ...
        <div class="col-md-6">
            ...
            <div class="map-responsive">
                <img src="{{asset('images/shop/map2.png')}}" loading="lazy"
                     data-src="{{asset('images/shop/map2.png')}}" class="w-100 lazyload" data-width="890" data-height="447">
            </div>
        </div>
        <div class="col-md-6 second-map">
            ...
            <div class="map-responsive">
                <img src="{{asset('images/shop/map1.png')}}" loading="lazy"
                     data-src="{{asset('images/shop/map1.png')}}" class="w-100 lazyload" data-width="890" data-height="450">
