<div class="block py-3">
    <div class="block-content d-flex" style="gap: 10px">
       @if($velocityMetaData->telegram_url)
        ...
        @endif
           @if($velocityMetaData->instagram_url)
               <a href="{{$velocityMetaData->instagram_url}}" class="h-100"><i class="fab fa-instagram  fa-2x"></i></a>
           @endif
           @if($velocityMetaData->aparat_url)
               <a href="{{$velocityMetaData->aparat_url}}" class="h-100">
                   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 68.33 68.33"  width="27px">
