@extends('admin::layouts.master') @php $is_teacher =
auth()->guard('admin')->user()?->role_id == config('app.teacher.role_id')
@endphp @section('page_title')
    ...
    <div class="page-content">
        ...
        <div class="graph-stats">
            ...
            <div class="right-card-container category">
                <div class="card">
                    ...
                    <div
                        class="card-info {{
                            !count($statistics['top_selling_products'])
                                ? 'center'
                                : ''
                        }}"
                    >
                        <ul>
                            @foreach ($statistics['top_selling_products'] as
                            $item)
                                        ...
                                        <img
                                            ...
                                            src="{{
                                                $productBaseImage[
                                                    ...
                                                    asset(
                                                        'vendor/webkul/ui/assets/images/product/small-product-placeholder.webp'
                                                    )
                                            }}"
                                        />
                                    </div>
            ...
            <div class="right-card-container category">
                <div class="card">
                    ...
                    <div
                        class="card-info {{
                            !count($statistics['top_selling_categories'])
                                ? 'center'
                                : ''
                        }}"
                    >
                        <ul>
                            @foreach ($statistics['top_selling_categories'] as
                            $item)

                            <li>
                                <a
                                    href="{{ route('admin.catalog.categories.edit', $item->category_id) }}"
                                >
        ...
        <div class="sale-stock">
            ...
            <div class="card">
                ...
                <div
                    class="card-info {{
                        !count($statistics['customer_with_most_sales'])
                            ? 'center'
                            : ''
                    }}"
                >
                    <ul>
                        @foreach ($statistics['customer_with_most_sales'] as
                        $item)
            ...
            <div class="card">
                ...
                <div
                    class="card-info {{
                        !count($statistics['stock_threshold']) ? 'center' : ''
                    }}"
                >
                    <ul>
                            ...
                            >
                                <div class="image">
                                    ...
                                    <img
                                        class="item-image"
                                        src="{{
                                            $productBaseImage['small_image_url']
                                        }}"
                                    />
                                </div>
